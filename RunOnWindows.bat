@echo off
REM *************************************************************************
REM * Script to help run githubreports on Windows from the githubreports "target" directory.
REM *
...
java -jar githubreports-1.0.0-SNAPSHOT.jar -l<GitHubLogin> -o<GitHubOrganization> -p<GitHubPassword or Personal Access Token>
